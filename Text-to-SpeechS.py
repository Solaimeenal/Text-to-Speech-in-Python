...
root.title('Solaimeenal - TEXT_TO_SPEECH')


##heading
Label(root, text = 'TEXT TO SPEECH' , font='algerian' , bg ='Yellow').pack()
Label(root, text ='Solaimeenal' , font ='algerian', bg = 'Yellow').pack(side = BOTTOM)
...
def Text_to_speech():
    ...
    speech.save('solaimeenal.mp3')
    playsound('solaimeenal.mp3')
